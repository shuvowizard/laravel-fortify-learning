...
<nav class="bg-white border-b border-gray-200">
    <div class="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div class="relative">
            ...
            {{-- Dropdown menu --}}
            <div id="nav-dropdown" class="hidden absolute right-0 mt-2 w-44 bg-white border border-gray-200
                ...
                <form method="POST" action="/logout">
                    @csrf
                    <button type="submit" class="flex items-center gap-2 w-full px-4 py-2.5 text-sm text-gray-700
